 ...
 */
public class ChooseTDActivity extends ActionBarActivity implements View.OnClickListener, DatePicker.OnDateChangedListener, TimePicker.OnTimeChangedListener {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            //返回键按下则返回至登录界面
            startActivity(new Intent(ChooseTDActivity.this, DataShowActivity.class));
            ChooseTDActivity.this.finish();
            return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butSureTD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View var1) {
                ...
                Intent intent = new Intent(ChooseTDActivity.this,DataShowActivity.class);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (code != null) {
                            //请求失败,给出原因
                            Looper.prepare();
                            Toast.makeText(ChooseTDActivity.this, responseMap.get("reason"), Toast.LENGTH_SHORT).show();
                            ...
                            if (result.length == 0) {//result没有元素表示没有可供查看的设备
                                ...
                                startActivity(new Intent(ChooseTDActivity.this, NULLDeviceActivity.class));
                                ChooseTDActivity.this.finish();
